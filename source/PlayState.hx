...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase) {
			...
			case 'pico-forever': songLowercase = 'forever';
		}
		...
		{
			case 'pico-forever':
				dialogue = CoolUtil.coolTextFile(Paths.txt('pico-forever/pico-foreverDialouge'));
			case 'senpai':
			...
			case 'flipaclip':
				{
						defaultCamZoom = 0.7;
						curStage = 'flipaclip';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('flipaclip/stage'));
						bg.antialiasing = true;
